                ...
                <div class="card h-md-100" dir="ltr">
                    ...
                    <div class="card-body d-flex flex-column flex-center">
                        ...
                        <div class="text-center mb-1">
                            ...
                            <!--end::Link-->
                            <!--begin::Link-->
                            <a class="btn btn-sm btn-light" href="../../demo9/dist/apps/invoices/view/invoice-2.html">Quick Guide</a>
                            <!--end::Link-->
                        </div>
                        <!--end::Links-->
                    </div>
                    ...
                    <div class="col-xxl-6">
                        ...
                        <div class="card card-flush h-lg-100">
                            ...
                            <div class="card-header py-7 mb-3">
                                ...
                                <!--begin::Toolbar-->
                                <div class="card-toolbar">
                                    <a href="../../demo9/dist/apps/ecommerce/sales/listing.html" class="btn btn-sm btn-light">View All</a>
                                </div>
                                <!--end::Toolbar-->
                            </div>
                            <!--end::Header-->
                ...
                <div class="card card-flush h-xl-100">
                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="text-center pt-9">
                            <a href="../../demo9/dist/apps/ecommerce/catalog/add-product.html" class="btn btn-primary">Add Vehicle</a>
                        </div>
                    </div>
                    <!--end::Body-->
                </div>
